    ...
    return <div>
        ...
        {props.users.map(u => <div id={u.id}>
            <span>
                ...
                <div>
                    {u.followed
                        ? <button disabled={props.progress} onClick={() => props.unfollowThunk(u.id)} >Unfollow</button>
                        : <button disabled={props.progress} onClick={() => props.followThunk(u.id)} >Follow</button>
                    }
                </div>
            </span>
            <span>
