let store = {
  ...
  writeWords: function (newLetter) {
    store.state.newPostText = newLetter;
    store.rerender(store);
  },

  writeMessage: function (newLetter) {
    store.state.newMessageText = newLetter;
    store.rerender(store);
  },
  ...
  stateCallback: function (observer) {
